...
export function TaxVerdict({ result }: Props) {
  ...
  return (
    <div className={cn(
      ...
      isOldBetter
        ? "border-blue-300 dark:border-blue-700 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/20"
        : "border-purple-300 dark:border-purple-700 bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/20"
    )}>
      {/* Top line */}
        ...
        {[
          {
            ...
            color: isOldBetter ? "border-blue-400 bg-blue-50/80 dark:bg-blue-950/40" : "border-border bg-background/60",
          ...
          },
          {
            ...
            isWinner: !isOldBetter,
            color: !isOldBetter ? "border-purple-400 bg-purple-50/80 dark:bg-purple-950/40" : "border-border bg-background/60",
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Effective rate: <span className="font-semibold text-foreground">{r.rate.toFixed(2)}%</span>
            </p>
          </div>
        ))}
      </div>
      ...
      <div className="flex items-center gap-2 pt-1 border-t border-white/40 dark:border-white/10">
        ...
        <p className="text-xs text-muted-foreground">
          Gross Income: <strong className="text-foreground">{fmtCr(result.gross_income)}</strong>
